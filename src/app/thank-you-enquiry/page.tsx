...
export const metadata: Metadata = {
  ...
  description: "Thanks for reaching out to GrowVibe — we've received your message.",
  robots: { index: false, follow: true },
};

export default function ThankYouEnquiryPage() {
  return (
      ...
      <div className="container flex flex-col items-center py-24 text-center">
        <Reveal>
          ...
          <p className="mx-auto mt-6 max-w-lg text-lg text-muted-foreground">
            A member of the GrowVibe team will review what you shared and
          ...
          <div className="mx-auto mt-8 flex max-w-md items-start gap-3 rounded-xl border border-border/70 bg-secondary/40 p-4 text-left">
            ...
            <p className="text-sm text-muted-foreground">
              <span className="font-medium text-foreground">Expected reply: within 4 hours</span>{" "}
              during business hours. Outside those hours, we&apos;ll
              be in touch first thing the next business day.
            </p>
          </div>
